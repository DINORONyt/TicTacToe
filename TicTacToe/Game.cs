...
namespace TicTacToe
{
    public class Game
    {
        ...
        // Выполнить ход
        // Выполнить ход
        // Добавлен параметр player для валидации очередности
        public bool MakeMove(int row, int col, Player player)
        {
            ...
            // ПРОВЕРКА: ход может сделать только текущий игрок
            // Это предотвращает два хода подряд одним игроком
            ...
            // Записываем символ игрока в ячейку
